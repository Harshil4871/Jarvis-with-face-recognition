...
def youtube(query):
	...
	print("Link mil gya")
	webbrowser.open('https://www.youtube.com/' + results[0]['id'])
	return "Enjoy Sir..."
...
def email(rec_email=None, text="Hello, It's J.A.R.V.I.S here...", sub='J.A.R.V.I.S'):
	if '@gmail.com' not in rec_email: return
	s = smtplib.SMTP('smtp.gmail.com', 587)
	s.starttls()
	s.login("jarvisassistant2104@gmail.com", "gcydxlvphtgoodyr") # eg, abc@gmail.com (email) and ****(pass)
	message = 'Subject: {}\n\n{}'.format(sub, text)
	s.sendmail("jarvisassistant2104@gmail.com", rec_email, message)
	print("Sent")
	s.quit()
