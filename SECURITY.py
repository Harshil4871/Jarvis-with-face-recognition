...
if __name__ == '__main__':
	...
	usernameLbl = Label(root4, text="Harshil Parmar", font=('Arial Bold',15), bg=background, fg='#85AD4F')
	...
	Label(root4, text="Launch the APP again to get started the conversation with your Personal Assistant Jarvis-", font=('arial',13), bg=background, fg='#A3A5AB', wraplength=350).pack()

	Button(root4, text='     OK     ', bg='#0475BB', fg='white',font=('Arial Bold', 18), bd=0, relief=FLAT, command=lambda:quit()).pack(pady=50)

	root.iconbitmap('extrafiles/images/jarvis.ico')
	raise_frame(root1)
	root.mainloop()
